...
from organizational_structure.serializer import ChartSerializer, CreateNodeSerializer, UpdateNodeSerializer
...
class NodeView(APIView) :
    ...
    def put(self, request, nodes_id) :
        try :
            ...
            self.service.update_nodes(nodes_id, **serializer.data)
